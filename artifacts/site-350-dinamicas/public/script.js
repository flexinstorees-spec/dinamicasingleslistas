...
function addPlanButtonEffects() {
    ...
    planButtons.forEach(button => {
        button.addEventListener('click', function(e) {
            const isPremium = this.classList.contains('premium-button');
            const href = this.getAttribute('href');

            // Só previne o default para botões sem destino real
            if (!isPremium) {
                e.preventDefault();
            }
...
const notificationMessages = [
    { name: 'Juan P.', product: '350 Dinámicas de Inglés', location: 'Ciudad de México, MX', time: 'hace 2 minutos' },
    { name: 'María S.', product: '350 Dinámicas de Inglés', location: 'Buenos Aires, AR', time: 'hace 5 minutos' },
    { name: 'Ana C.', product: '350 Dinámicas de Inglés', location: 'Bogotá, CO', time: 'hace 8 minutos' },
    { name: 'Pedro L.', product: '350 Dinámicas de Inglés', location: 'Lima, PE', time: 'hace 12 minutos' },
    { name: 'Fernanda M.', product: '350 Dinámicas de Inglés', location: 'Santiago, CL', time: 'hace 15 minutos' }
];
